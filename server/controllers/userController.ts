    ...
    try {
        ...
        await prisma.conversation.create({
            data: {
                role: 'assistant',
                content:
                `I've enhanced your prompt to: "${enhancedPrompt}"`, projectId: project.id
            }
        })
...
export const getUserProject = async (req: Request, res: Response) => {
    try{
        ...
        //changes made for error to be fixed for id  it was "const { projectId } = req.params;"
...
export const togglePublish = async (req: Request, res: Response) => {
    try{
        ...
        //changes made for error to be fixed for id
        const projectId = String(req.params.projectId);
